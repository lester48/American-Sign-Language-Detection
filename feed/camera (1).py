    ...
    def findHands(self,img, draw = True):
        ...
        if self.results.multi_hand_landmarks:
            ...
            for hand_landmark in self.results.multi_hand_landmarks:
                ...
                cv2.rectangle(img, (center[0]-120,center[1]-200), (center[0]+120,center[1]+220), (255,0,0), 1)
                coordinates = {'X': center[0]-120, 'Y': center[1]-200, 'X+W': center[0]+120,'Y+H': center[1]+220}
...
def main():
    ...
    while True:
        ...
        if k%256==27:
            print("A ",pp)
            cv2.imwrite(os.path.join(paths,"image.jpg"),pp)
            cap.release()
